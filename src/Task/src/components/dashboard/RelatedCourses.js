    ...
    <div className="bg-white rounded-[18px] shadow-sm border border-gray-light-D3 p-4 sm:p-6">
      ...
      <div className="space-y-3 sm:space-y-4">
          {courses.map((course) => (
            <div 
            key={course.id}
              className="block bg-white border border-gray-light-D3 rounded-lg hover:shadow-md transition-shadow cursor-pointer"
              onClick={() => navigateToCourse(course)}
          >
              <div className="flex">
                <div className="w-20 sm:w-1/3 h-16 sm:h-24 bg-gray-100 rounded-l-lg overflow-hidden flex-shrink-0">
              ...
              <img 
                ...
                className="w-full h-full object-cover"
                      onError={(e) => {
                        ...
                        e.target.src = "/public/images/team-meeting.jpg";
                      }}
                    />
                  ) : (
                    <div className="w-full h-full bg-orange-100 flex items-center justify-center text-orange-light">
                      <svg width="24" height="24" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 sm:w-10 sm:h-10">
                        <path d="M36.6667 20.0002C36.6667 29.2002 29.2 36.6668 20 36.6668C10.8 36.6668 3.33334 29.2002 3.33334 20.0002C3.33334 10.8002 10.8 3.3335 20 3.3335C29.2 3.3335 36.6667 10.8002 36.6667 20.0002Z" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M26.1833 25.3L21.0167 22.2167C20.1167 21.6833 19.4 20.4 19.4 19.35V11.8167" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                  )}
                </div>
                ...
                <div className="flex-1 p-3 sm:p-4">
                  <h3 className="font-medium text-black-0 text-xs sm:text-md line-clamp-2">{course.title}</h3>
                  
                  <p className="text-xs text-gray-500 mt-1 mb-2 line-clamp-2 hidden sm:block">
