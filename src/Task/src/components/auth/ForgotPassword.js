          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="w-full md:w-1/2 lg:w-5/12 mb-10 md:mb-0">
              <div className="max-w-md mx-auto">
                <h2 className="text-3xl font-bold text-black-0 mb-2">Forgot Password</h2>
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="email" className="block text-base font-semibold text-black-0 mb-1">
                      Email ID
                    </label>
                    <Input
                      id="email"
                  ...
                  <div className="flex space-x-4 w-full gap-4">
                    <Link to="/signin" className='w-full'>
                      <Button
                        type="button"
                        variant="outline"
                        className="py-3 !rounded-full !font-bold w-full"
                      >
                        Back
                      </Button>
                    </Link>
